...
import com.akg.imdgperfcheck.util.QueryExecutionCounter;
import com.akg.imdgperfcheck.util.QueryUtil;
import com.akg.imdgperfcheck.util.WinesDataLoader;
...
public abstract class AbstractCommand {
	...
	public int delete(Execution execution, List<Query> deleteQueries) {
		...
		Map<Integer, Query> queriesMap = QueryUtil.calculatePercentageExecForQueries(deleteQueries);
		long start = System.currentTimeMillis();
		long endTimeInMs = start + (execution.getTimeInMs());
